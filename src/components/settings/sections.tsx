import { LayoutGrid, Globe, Bot, ShieldCheck, Wrench, Cpu, UsersRound, Contact } from "lucide-react";
...
export const SETTINGS_SECTIONS = [
  ...
  { href: "/settings/users", icon: Contact, key: "navUsers", descKey: "cardUsersDesc" },
